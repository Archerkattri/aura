...
class CaptureManifest:
    ...
    @classmethod
    def from_dict(cls, payload: dict, *, validate: bool = True) -> "CaptureManifest":
...
def load_capture_manifest(path: Path | str, *, validate: bool = True) -> CaptureManifest:
    ...
    validate=False skips jsonschema validation (saves 5-7 min for large manifests
    with N>100k elements). Safe when the manifest was generated by aura ingest.
    """
    ...
    return CaptureManifest.from_dict(payload, validate=validate)
