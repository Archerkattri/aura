...
`experiments/results/external_baselines_2026-06-24.json` with fresh CUDA
same-split smoke summaries in
`experiments/results/baseline_3dgs_smoke_2026-06-24.txt` and
`experiments/results/external_baseline_smokes_2026-06-24.json`.
